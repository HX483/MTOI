...
public class WarehouseController extends BaseController
{
     ...
     * 查询仓库列表
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:list')")
    @GetMapping("/list")
     ...
     * 导出仓库列表
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:export')")
     ...
     * 获取仓库详细信息
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:query')")
     ...
     * 新增仓库
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:add')")
     ...
     * 修改仓库
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:edit')")
     ...
     * 删除仓库
     */
    @PreAuthorize("@ss.hasPermi('stock:warehouse:remove')")
