...
系统现已完成全部开发，以下是主要功能模块的界面展示：

#### 总览与管理
| 信息总览 | 个人中心 | 夜间模式 |
| :--- | :--- | :--- |
| <img src="./img/system/信息总览.png" width="300" height="200"> | <img src="./img/system/个人中心.png" width="300" height="200"> | <img src="./img/system/夜间模式.png" width="300" height="200"> |

#### 业务管理模块
| 产品管理 | 订单管理 | 原料管理 |
| :--- | :--- | :--- |
| <img src="./img/system/产品管理模块.png" width="300" height="200"> | <img src="./img/system/订单管理模块.png" width="300" height="200"> | <img src="./img/system/原料管理模块.png" width="300" height="200"> |

#### 库存与采购
| 库存管理 | 采购管理 |
| :--- | :--- |
| <img src="./img/system/库存管理模块.png" width="300" height="200"> | <img src="./img/system/采购管理模块.png" width="300" height="200"> |

## 开发计划

系统开发分为六个阶段，现已基本完成,后续会嵌入大模型助理：
1. **系统基础设施**（已完成）：基于MTOI框架的基础功能
2. **核心业务模块开发**（已完成）：产品管理、原料管理、库存管理
3. **订单管理模块开发**（已完成）：订单创建、流程管理、查询统计
4. **采购管理模块开发**（已完成）：供应商管理、采购订单、采购入库
5. **报表分析模块开发**（已完成）：销售报表、原料消耗报表、成本分析
