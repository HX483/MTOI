...
public interface ProductInfoMapper 
{
     ...
     * @return 结果
     */
    public int batchProductAttribute(List<ProductAttribute> productAttributeList);
     ...
     * @return 结果
     */
    public int deleteProductAttributeByProductId(Long productId);
     ...
     * @return 结果
     */
    public int deleteProductAttributeByProductIds(Long[] productIds);
}
